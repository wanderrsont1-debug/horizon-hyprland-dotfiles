...
# Default: 0 (AC), 2 (BAT)
#Seconds laptop mode waits after the disk goes idle before syncing dirty cache blocks from RAM to disk again. Values > 0 activate kernel laptop mode. Do not change this setting.
...
# ~ ❯ sudo tlp diskid
# nvme0n1: nvme-Samsung_SSD_980_1TB_S649NL0T857112D
# nvme1n1: nvme-INTEL_SSDPEKNU512GZ_BTKA151410KY512A
...
# Default: keep
#check all suported options for your block drive one by one with the folowing commaand make sure to change the block name with your block name before running the command : 
...
# Default: 15
# Going lower (5–10s) would cause more frequent wake/sleep cycles and actually increase average power draw due to the wakeup energy cost
...
#/sys/class/drm/card0/device/power_state      = D3cold
#+++ Intel Graphics
