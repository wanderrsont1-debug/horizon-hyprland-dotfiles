### Step 3: Create a Custom `git_horizon` Alias
...
alias git_horizon='/usr/bin/git --git-dir=$HOME/horizon/ --work-tree=$HOME'
```

*   `--git-dir=$HOME/horizon/`: Tells Git where to find its database (our bare repository).
