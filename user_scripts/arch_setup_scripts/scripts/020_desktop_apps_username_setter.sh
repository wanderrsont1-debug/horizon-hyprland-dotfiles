...
readonly TARGET_FILES=(
    ...
    "horizon_appearances.desktop"
    "horizon_battery_notify.desktop"
    "horizon_control_center.desktop"
    "horizon_hyprlock_switcher.desktop"
    "horizon_hypridle_timeout.desktop"
    "horizon_hypridle_toggle.desktop"
    "horizon_input.desktop"
    "horizon_glance.desktop"
    "horizon_gsettings.desktop"
    "horizon_keybinds.desktop"
    "horizon_locale_tui.desktop"
    "horizon_monitor.desktop"
    "horizon_matugen_presets.desktop"
    "horizon_network.desktop"
    "horizon_packages.desktop"
    "horizon_power.desktop"
    "horizon_waybars.desktop"
    "horizon_wayclick_config.desktop"
    "horizon_window_rules.desktop"
    "horizon_workspace.desktop"
    "horizon_site_blocker.desktop"
    "horizon_quickpanal.desktop"
    "horizon_service_toggle.desktop"
