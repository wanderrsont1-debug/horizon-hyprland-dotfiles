...
declare -ar pkgs_graphics=(
  "mesa" "vulkan-icd-loader" "vulkan-tools" "sof-firmware" "linux-firmware" "base" "base-devel" "kernel-modules-hook"
)
...
declare -ar pkgs_filesystem=(
  "btrfs-progs" "compsize" "zram-generator" "udisks2" "udiskie" "dosfstools" "ntfs-3g" "xdg-user-dirs" "usbutils" "gnome-disk-utility" "rsync" "nfs-utils" "nilfs-utils" "smartmontools" "dmraid" "hdparm" "hwdetect" "lsscsi" "sg3_utils" "cpupower" "dust" "dkms" "nautilus" "nautilus-image-converter"
)
...
declare -ar pkgs_terminal=( 
  "ghostty" "foot" "zsh" "zsh-syntax-highlighting" "starship" "fastfetch" "bat" "eza" "fd" "yazi" "gum" "tree" "fzf" "less" "ripgrep" "expac" "zsh-autosuggestions" "iperf3" "pkgstats" "libqalculate" "moreutils" "zoxide" "man-db" "lsof" "khal"
)
