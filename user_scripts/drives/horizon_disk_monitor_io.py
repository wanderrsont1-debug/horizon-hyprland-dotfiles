...
"""
Horizon Disk Real-Time System I/O Monitor (Hyper-Sleek Final Edition)
...
def load_theme() -> dict:
    ...
    path = Path("~/.config/matugen/generated/horizon_tui.json").expanduser()
    defaults = {
        "bg": "#0e1416",
        "fg": "#dee3e5",
        "accent": "#82d3e2",
...
class IOMonitorApp(App):
    ...
    def compose(self) -> ComposeResult:
        self.title = "Horizon Disk I/O Monitor"
        yield Static("Horizon Disk I/O Monitor", id="custom_header")
