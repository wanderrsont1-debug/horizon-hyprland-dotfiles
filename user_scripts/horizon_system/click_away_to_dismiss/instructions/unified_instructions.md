...
btw the path to the file generated is this ~/user_scripts/horizon_system/click_away_to_dismiss/libwaylandgrab.so
...
## 📦 2. Source Code Reference (`horizon.c`)

This is the unified C extension source code. Place this file in `~/user_scripts/horizon_system/click_away_to_dismiss/horizon.c`.

*(Note: Ensure your `hyprland-focus-grab-v1.xml` file is in the same directory prior to compilation.)*

```c
/*
 * horizon.c — Unified Wayland Focus-Grab Extension (GTK3 + GTK4)
 *
