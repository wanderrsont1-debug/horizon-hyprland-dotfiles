...
# Purpose: Forcefully manages the Horizon quickpanal lifecycle.
...
# Configuration
# -----------------------------------------------------------------------------
readonly APP_NAME="Horizon quickpanal"
readonly SERVICE_NAME="horizon_quickpanal.service"
readonly PROCESS_PATTERN='horizon_quickpanal\.py'
readonly GUI_SCRIPT_PATH="${HOME}/user_scripts/horizon_system/quickpanal/horizon_quickpanal.py"
