#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Script: restart_horizon_cc.sh
# Purpose: Forcefully manages the Horizon Control Center lifecycle.
...
# Configuration
# -----------------------------------------------------------------------------
readonly APP_NAME="Horizon Control Center"
readonly SERVICE_NAME="horizon.service"
readonly PROCESS_PATTERN='horizon_control_center\.py'
readonly GUI_SCRIPT_PATH="${HOME}/user_scripts/horizon_system/control_center/horizon_control_center.py"
