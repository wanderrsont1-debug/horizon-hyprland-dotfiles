...
logger = logging.getLogger("horizon_network_engine")
...
class NetworkManagerEngine(BaseEngine):
    """
    Async-first NetworkManager engine for the Horizon TUI ecosystem.
    
    Features:
    - Instant startup from cached scan results (~/.cache/horizon_tui/wifi_cache.json)
    ...
    def __init__(self, config_path: str = ""):
        self.cache_dir = Path.home() / ".cache" / "horizon_tui"
