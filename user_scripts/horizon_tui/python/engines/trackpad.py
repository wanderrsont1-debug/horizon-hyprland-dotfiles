...
"""
===============================================================================
HORIZON TUI: HYBRID TRACKPAD ENGINE
===============================================================================
...
def get_friendly_name(block_str: str) -> str:
    ...
    if "org.horizon.quickpanal" in block_str: return "Toggle Horizon QuickPanel"
