...
class HorizonTUI(App):
    ...
    def __init__(self, engine_pool: dict[tuple[str, str], BaseEngine], default_engine_key: tuple[str, str], schema: dict[int, list[ConfigItem]], tabs: list[str], title="Horizon Editor", theme_path: str | None = None, default_mode: str = "auto", schema_name: str = "default", enable_user_presets: bool = True, user_presets_tab: str | None = None, global_popup: Any | None = None, tab_notices: dict[int, dict | list[dict]] | None = None, **kwargs):
        ...
        self.user_presets_dir = Path(f"~/.config/horizon/tui/{self.schema_name}").expanduser().resolve()
    ...
    def apply_theme_to_engine(self) -> None:
        ...
        theme_name = "horizon_matugen_A" if self._theme_toggle else "horizon_matugen_B"
