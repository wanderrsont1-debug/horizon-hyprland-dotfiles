#!/usr/bin/env python3
"""
Horizon Windows KVM & Looking Glass Manager
...
def get_state_file_info():
    ...
    state_file = home_dir / ".config" / "horizon" / "settings" / "virt" / "win_state"
...
def print_help():
    title_panel = Panel(
        "[bold cyan]Horizon Windows KVM & Looking Glass Manager[/bold cyan]",
        border_style="cyan",
        expand=False
    )
