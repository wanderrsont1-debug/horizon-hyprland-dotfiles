...
hl.on("hyprland.start", function()
    ...
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --cpu-power")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --ram")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --ram-temp")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --temp")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --battery")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --battery-percent")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --battery-watts")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --battery-time")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --gpu-power card1 Intel")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --gpu-usage card1 Intel")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --gpu-mem card1 Intel")
    ...
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --clock-short")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --disk")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --disk-read nvme0n1")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --disk-write nvme0n1")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --disk-temp nvme0n1")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --zram")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --stopwatch")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --timer 15m")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --pomodoro")
    -- hl.exec_cmd("~/user_scripts/rofi/horizon_glance.sh --stop")
