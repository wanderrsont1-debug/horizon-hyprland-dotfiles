...
hl.workspace_rule({ workspace = "2", layout = "scrolling", persistent = false })
hl.workspace_rule({ workspace = "3", layout = "scrolling", persistent = false })
hl.workspace_rule({ workspace = "4", layout = "scrolling", persistent = false })
hl.workspace_rule({ workspace = "5", layout = "scrolling", persistent = false })
hl.workspace_rule({ workspace = "6", layout = "scrolling", persistent = false })
hl.workspace_rule({ workspace = "7", layout = "scrolling", persistent = false })
hl.workspace_rule({ workspace = "8", layout = "scrolling", persistent = false })
hl.workspace_rule({ workspace = "9", layout = "scrolling", persistent = false })
hl.workspace_rule({ workspace = "10", layout = "scrolling", persistent = false })
