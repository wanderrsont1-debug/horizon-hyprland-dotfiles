#!/usr/bin/env python3
"""
Horizon Monitor Wizard - Hyprland Edition v6.5.0 (Ultimate Lua Engine)
-----------------------------------------------------------------------------
