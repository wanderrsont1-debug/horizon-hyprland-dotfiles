#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Horizon TUI Engine - Master v4.4.1 (Ultimate Hyprland 0.54 Edition)
# -----------------------------------------------------------------------------
...
declare -r APP_TITLE="Horizon Workspace Manager"
    ...
    if [[ ! -f "${CONFIG_FILE}" || ! -s "${CONFIG_FILE}" ]]; then
        {
            ...
            printf '# Managed by Horizon TUI - Granular Matrix v4.4.1\n'
            printf '# ==============================================================================\n\n'
