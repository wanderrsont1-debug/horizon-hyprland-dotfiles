...
"""
===============================================================================
HORIZON TUI: HYPRIDLE CONFIGURATION SCHEMA
===============================================================================
"""
import sys
from pathlib import Path

# Inject the horizon_tui root into sys.path for direct execution
_HORIZON_TUI_ROOT = Path(__file__).resolve().parent.parent / "horizon_tui"
if str(_HORIZON_TUI_ROOT) not in sys.path:
    sys.path.insert(0, str(_HORIZON_TUI_ROOT))
...
if __name__ == "__main__":
    import subprocess
    main_script = _HORIZON_TUI_ROOT / "python" / "main" / "main.py"
