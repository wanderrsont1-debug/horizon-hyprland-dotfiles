...
"""
===============================================================================
HORIZON TUI: DYNAMIC MAKO GLANCE COMPONENT SCHEMA
===============================================================================
...
APP_TITLE = "Horizon Glance Config"                 
...
def build_standard_glance(suffix, label_name, group_name="Modules"):
    ...
    mapped exactly to the specified [app-name=horizon-glance-{suffix}] scope.
    """
    app_name = f"horizon-glance-{suffix}" if suffix else "horizon-glance"
    ...
    return [
        ...
        ConfigItem(
            ...
            options=[
                ...
                'exec bash -c "pkill rofi; uwsm-app -- $HOME/user_scripts/rofi/horizon_glance.sh"'
            ],
            parent_ref=uid,
...
SCHEMA = {
    ...
    6: [
        ...
        ConfigItem(
            ...
            extended_help="**Sanity Reset**\n\nDid you break the Rofi shell execution hook or mess up the geometry? Triggering this profile restores every widget/alert parameter identically to the original Horizon default specifications."
        ),
    ]
}
