#!/usr/bin/env bash
# ==============================================================================
# horizon_wireguard_setup.sh
# ==============================================================================
# Run once to configure the system for the Horizon WireGuard CC integration:
...
#   3. Installs /etc/sudoers.d/horizon-wireguard granting NOPASSWD for wg-quick
# ==============================================================================
set -euo pipefail
...
SUDOERS_FILE="/etc/sudoers.d/horizon-wireguard"
info "Installing sudoers rules to $SUDOERS_FILE ..."

sudo tee "$SUDOERS_FILE" > /dev/null <<EOF
# Horizon WireGuard CC integration — allow wheel members to manage tunnels
