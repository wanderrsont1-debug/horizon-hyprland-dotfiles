...
def display_status_table(p_cores: list[int], e_cores: list[int], locked_cores: set[int]) -> None:
    console.print(Align.center(Panel("[bold magenta]Horizon Core Manager[/bold magenta]", border_style="cyan", expand=False)))
