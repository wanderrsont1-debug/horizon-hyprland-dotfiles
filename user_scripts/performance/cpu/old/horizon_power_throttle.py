#!/usr/bin/env python3
"""
Horizon Power Throttle (v7.0 - Apex)
...
def display_help() -> None:
    ...
    console.print(Panel.fit("[bold cyan]Horizon Power Throttle - Master Manual[/bold cyan]", border_style="cyan"))
...
STATE_FILE = Path("/dev/shm/horizon_rapl_state.json")
...
def display_status(throttle: PowerThrottle) -> None:
    ...
    status_panel = Panel(
        table,
        title="[bold magenta] Horizon Power Throttle [/bold magenta]",
        border_style="cyan",
        expand=False
    )
