#!/usr/bin/env python3
"""
Horizon Monitor - Advanced Live System Resource Monitor
...
def _ensure_dependencies() -> None:
    ...
    if missing:
        print(f"\033[94m[Horizon Monitor]\033[0m Missing dependencies detected: \033[93m{', '.join(missing)}\033[0m")
...
# =============================================================================
# MAIN APPLICATION: Horizon Monitor
# =============================================================================
class HorizonMonitorApp(App):
    CSS = """
    ...
    def __init__(self, cli_config: dict[str, Any], *args: Any, **kwargs: Any) -> None:
        ...
        self.theme_path = Path("~/.config/matugen/generated/horizon_tui.json").expanduser().resolve()
    ...
    def apply_theme_to_engine(self) -> None:
        ...
        theme_name = "horizon_live_A" if self._theme_toggle else "horizon_live_B"
    ...
    def on_mount(self) -> None:
        self.query_one("#main-box").border_title = " Horizon Monitor"
...
if __name__ == "__main__":
    ...
    app = HorizonMonitorApp(cli_config)
    app.run()
