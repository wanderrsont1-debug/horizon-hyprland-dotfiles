#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Horizon Matugen TUI - Dynamic TOML Manager
...
# =============================================================================
# ▼ HORIZON MATUGEN TUI - CONFIGURATION GUIDE ▼
# =============================================================================
...
register_items() {
    ...
    register_template 1 "Horizon Control"  "horizon_control_center" "false" ""
    register_template 1 "Horizon QuickPanal"  "horizon_quickpanal"        "false" ""
