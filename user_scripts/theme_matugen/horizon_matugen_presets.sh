#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Horizon Matugen Presets v4.1.1 (Production Release)
# -----------------------------------------------------------------------------
...
declare -r APP_TITLE="Horizon Matugen Presets"
declare -r APP_VERSION="v4.1.1"

# --- State & Favorites Paths ---
declare -r USE_STATE_FILE=true
declare -r STATE_DIR="${HOME}/.config/horizon/settings/horizon_theme"
...
save_favorites() {
    ...
    printf '# Horizon Matugen Favorites\n' > "$tmpfile"
