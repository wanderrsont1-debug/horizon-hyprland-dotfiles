#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Horizon Kokoro TUI Engine - Master v5.0.2 (Defaults & Parser Fix)
# -----------------------------------------------------------------------------
...
declare -r CONFIG_FILE="${HOME}/contained_apps/uv/horizon_kokoro/horizon_main.py"
declare -r TRIGGER_SCRIPT="${HOME}/user_scripts/tts_stt/horizon_kokoro/trigger.sh"
...
check_daemon_status() {
    local pid_file="/tmp/horizon_kokoro.pid"
