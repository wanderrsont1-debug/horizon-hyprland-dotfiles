...
AUDIO_DIR = ZRAM_MOUNT if ZRAM_MOUNT.is_dir() else Path("/tmp/horizon_stt_audio")
...
logger = logging.getLogger("horizon_stt")
...
class HorizonSTTDaemon:
    def __init__(self):
        self.running = True
        logger.info(f"Horizon STT Daemon {VERSION} Initializing...")
...
if __name__ == "__main__":
    ...
    if args.daemon: HorizonSTTDaemon().start()
