#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Horizon WayClick Configurator - TUI v1.0.0
# -----------------------------------------------------------------------------
# Target: Arch Linux / Hyprland / UWSM / Wayland
# Engine: Horizon TUI Engine v3.9.5 (Hardened)
#
...
declare -r CONFIG_FILE="${HOME}/user_scripts/wayclick/horizon_wayclick.sh"
declare -r APP_TITLE="Horizon WayClick Configurator"
